...
public class usuarioAdmiDAO extends MySQLConexion{
    public usuarioAdmi identificar(usuarioAdmi user) throws Exception{
        ...
        Statement st=null;
        ResultSet rs=null;
        /*String sql="select usuario,password,id_admi 
        from usuarioadmi where usuario='"+user.getUsuario()+"' and 
        password='"+user.getPassword()+"'";*/
         String sql="select u.usuario,u.password,a.nombre"
        ...
        try{
            ...
            if(rs.next() == true){
             ...
             //   usu.setId_admi(rs.getString("id_admi"));
                ...
                usu.getId_admi().setId_admi(rs.getString("id_admi"));
